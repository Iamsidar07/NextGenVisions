  ...
  return (
    <section className='w-full flex-col flex items-center mt-12 mb-40 '>
      <h1 className='text-6xl sm:text-8xl font-extrabold text-center'>
        <span>Imagine.</span><br className='sm:hidden' />
        <span>Generate.</span><br className='sm:hidden' />
        <span className='text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-500'>Share.</span>
      </h1>
